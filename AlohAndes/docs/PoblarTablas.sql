...
INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(1, 'ApartamentosKpos', 'CRA 16',250000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(2, 'ApartamentosLindos', 'CRA 12',260000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(3, 'ApartamentosOK', 'CRA 13',270000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(4, 'ApartamentosFelices', 'CRA 12',270000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(5, 'HabitacionFelicia', 'CRA 7',250000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(6, 'HabitacionNoC', 'CRA 20',260000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(7, 'HabitacionXD', 'CRA 2',270000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(8, 'Habitacion lol', 'CRA 1',270000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(55, 'city U', 'CRA 16',260000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(56, 'ViviendaUniversitariaUnica', 'CRA 25',270000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(57, 'ViviendaUniversitariaDos', 'CRA 18',270000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(70, 'Sol caribe', 'CRA 16',260000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(71, 'Hotel Famoso', 'CRA 25',270000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(72, 'HotelKpo ', 'CRA 18',270000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(80, 'Hostal2', 'CRA 15',260000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(81, 'HostalDosPorUno', 'CRA 16',270000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(82, 'Hostal El mejor ', 'CRA 1',270000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(83,'La Casa Mickey Mouse','CL 80',500000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(84,'La Casita del bosque','CL 82A',380000);

INSERT INTO HOSPEDAJE (idHospedaje,nombre, direccion, valorTotal)
VALUES(85,'Casa chiquita','CRA 5',250500);
...
INSERT INTO CONTRATO (idContrato, valor, fecha_final, fecha_inicio, idHospedaje,idCedulaCliente, NIT_EMPRESA, cedulaPersonaNatural)
VALUES(2,1000000, '27-03-2020','29-03-2020',2, 1000944002, 1000000020, null);

INSERT INTO CONTRATO (idContrato, valor, fecha_final, fecha_inicio, idHospedaje,idCedulaCliente, NIT_EMPRESA, cedulaPersonaNatural)
VALUES(3,1000000, '27-03-2020','29-03-2020',3, 1000944002, 1000000020, null);

INSERT INTO CONTRATO (idContrato, valor, fecha_final, fecha_inicio, idHospedaje,idCedulaCliente, NIT_EMPRESA, cedulaPersonaNatural)
VALUES(4,1000000, '28-03-2020','30-03-2020',4, 1000944002, 1000000020, null);
